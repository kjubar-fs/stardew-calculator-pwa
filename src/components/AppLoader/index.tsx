 ...
 *  Last update: 12 Sep 2024, 12:27:27 PM
 *  Copyright (c) 2024 Kaleb Jubar
 */
import { useEffect, useState } from "react";

import { ClientMessage, MessageType } from "../../includes/variables";
...
export default function AppLoader() {
    ...
    const msgHandler = (event: MessageEvent) => {
        ...
        if (msg instanceof ClientMessage && msg.type === MessageType.RefreshData) {
